                                    ...
                                    <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sorrt" data-sort="email" scope="col">Email</th>
                                                <th class="sorrt" data-sort="phone" scope="col">Phone</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 ms-2 name"><?php echo $supplier['comp_name']; ?>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="industry_type"><?php echo $supplier['address']; ?></td>
