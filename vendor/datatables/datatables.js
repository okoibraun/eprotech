 ...
 *   https://datatables.net/download/#bs5/dt-1.12.1/r-2.3.0/sb-1.3.4/sp-2.0.2
 *
 * Included libraries:
 *   DataTables 1.12.1, Responsive 2.3.0, SearchBuilder 1.3.4, SearchPanes 2.0.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs5/dt-1.12.1/r-2.3.0/sb-1.3.4/sp-2.0.2",
